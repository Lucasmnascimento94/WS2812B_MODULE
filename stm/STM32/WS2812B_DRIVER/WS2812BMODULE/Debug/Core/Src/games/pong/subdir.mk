...
CPP_SRCS += \
../Core/Src/games/pong/Pong.cpp 

OBJS += \
./Core/Src/games/pong/Pong.o 

CPP_DEPS += \
./Core/Src/games/pong/Pong.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/games/pong/%.o Core/Src/games/pong/%.su Core/Src/games/pong/%.cyclo: ../Core/Src/games/pong/%.cpp Core/Src/games/pong/subdir.mk
...
clean: clean-Core-2f-Src-2f-games-2f-pong

clean-Core-2f-Src-2f-games-2f-pong:
	-$(RM) ./Core/Src/games/pong/Pong.cyclo ./Core/Src/games/pong/Pong.d ./Core/Src/games/pong/Pong.o ./Core/Src/games/pong/Pong.su

.PHONY: clean-Core-2f-Src-2f-games-2f-pong
