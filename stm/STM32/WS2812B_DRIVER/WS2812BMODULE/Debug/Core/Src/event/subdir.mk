...
CPP_SRCS += \
../Core/Src/event/Event.cpp 

OBJS += \
./Core/Src/event/Event.o 

CPP_DEPS += \
./Core/Src/event/Event.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/event/%.o Core/Src/event/%.su Core/Src/event/%.cyclo: ../Core/Src/event/%.cpp Core/Src/event/subdir.mk
...
clean: clean-Core-2f-Src-2f-event

clean-Core-2f-Src-2f-event:
	-$(RM) ./Core/Src/event/Event.cyclo ./Core/Src/event/Event.d ./Core/Src/event/Event.o ./Core/Src/event/Event.su

.PHONY: clean-Core-2f-Src-2f-event
