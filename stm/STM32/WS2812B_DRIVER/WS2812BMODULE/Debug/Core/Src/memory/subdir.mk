...
CPP_SRCS += \
../Core/Src/memory/memory.cpp 

OBJS += \
./Core/Src/memory/memory.o 

CPP_DEPS += \
./Core/Src/memory/memory.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/memory/%.o Core/Src/memory/%.su Core/Src/memory/%.cyclo: ../Core/Src/memory/%.cpp Core/Src/memory/subdir.mk
...
clean-Core-2f-Src-2f-memory:
	-$(RM) ./Core/Src/memory/memory.cyclo ./Core/Src/memory/memory.d ./Core/Src/memory/memory.o ./Core/Src/memory/memory.su
