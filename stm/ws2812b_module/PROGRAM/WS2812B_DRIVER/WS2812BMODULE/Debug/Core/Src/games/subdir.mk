...
CPP_SRCS += \
../Core/Src/games/Game.cpp 

OBJS += \
./Core/Src/games/Game.o 

CPP_DEPS += \
./Core/Src/games/Game.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/games/%.o Core/Src/games/%.su Core/Src/games/%.cyclo: ../Core/Src/games/%.cpp Core/Src/games/subdir.mk
...
clean: clean-Core-2f-Src-2f-games

clean-Core-2f-Src-2f-games:
	-$(RM) ./Core/Src/games/Game.cyclo ./Core/Src/games/Game.d ./Core/Src/games/Game.o ./Core/Src/games/Game.su

.PHONY: clean-Core-2f-Src-2f-games
